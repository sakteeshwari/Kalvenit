...
import Biznextpageicon from "@/app/components/Biznextpageicon/Biznextpageicon";
import Biznextpageachieve from "@/app/components/Biznextpageachieve/Biznextpageachieve";
...
const BizNextSlugPage = () => {
  ...
  const solution = bizNextData[slug as string] || defaultContent;
