...
const Careerspagecome = () => {
    
    return (
        <div className=" relative py-10 bg-yellow-400 from-gray-50 to-gray-100 p-4 my-10 mt-10 lg:px-32 rounded-xl shadow-lg">
...
export default Careerspagecome
