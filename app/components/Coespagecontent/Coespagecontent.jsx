...
const Coespagecontent = () => {
  const content = [
    ...
    },
    {
      ...
      link: "/coes/integration-services",
    },
  ];
          ...
          {content.map((item, index) => (
            <div key={index}>
              <Link href={item.link} passHref>
                <div className="service-item mt-10 cursor-pointer flex-grow flex items-center justify-start my-4 group hover:bg-gray-200 p-4 transition-all duration-300">
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
