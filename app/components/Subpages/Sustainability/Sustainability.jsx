  ...
  const services = [
    {
      title: "Safe@Work",
      description:
        "Ensure the safety of the workplace and strengthen the protection and control protocols.",
      link: "/services/sustainability/regulatory",
    },
    {
      title: "Regulatory (SDS) Documentation",
      description:
        "Keep regulatory documents up-to-date to meet compliance standards.",
        link: "/services/sustainability/regulatory",
    },
    {
      title: "SafetyOne",
      description:
        "An agile solution to meet occupational health and safety requirements.",
        link: "/services/sustainability/safetyone",
    },
    {
      title: "SAP Environment, Health & Safety Management",
      description:
        "A cost-effective solution to systematically reduce risks and improve worker and process safety.",
        link: "/services/sustainability/sap-ehs",
    },
    {
      title: "SAP Product Safety & Stewardship",
      description:
        "Streamline and automate your product stewardship and compliance processes to reduce the overall cost of compliance.",
        link: "/services/sustainability/sap-product-safety",
    },
  ];
