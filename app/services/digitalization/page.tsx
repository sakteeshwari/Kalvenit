  ...
  return (
    <DigitalizationLayout imgSrc="/assets/digitalizationpageimg.png">
      <div className="bg-gray-200 p-4 leading-relaxed tracking-wider">
        ...
        <p className="mt-6">
          With extensive experience helping organizations across industry verticals to digitalize their business operations, KALVEN helps companies innovate their digital strategies and amplify the link between clients and business outcomes.
        </p>
        <p className="mt-6">
          KALVEN deploys its proven methodologies to help organizations reimagine future-ready business models. We put together digital strategy-roadmaps, create digital organizations, draft appropriate digital business models, launch agile product development methodologies, and build agile IT infrastructure.
        </p>
        <p className="mt-6">
